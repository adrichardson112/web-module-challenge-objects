...
const burger = {
  ...
  discount(special) {
    let cost;
    if ((special === "teacher", "student")) cost = this.price * 0.75;
    if (special === "public") cost = this.price * 0.9;
...
console.log(createMenuItem("Cheese Fries", 5, "Sides"));
console.log(createMenuItem("Sundae", 6, "Sweets"));
console.log(createMenuItem("Berry Hibiscus", 3, "Teas"));
...
function recallJuliusData(reviews, idperson) {
  for (let i = 0; i < reviews.length; i++) {
    if (reviews[i].name === idperson) {
    }
    return reviews.feedback;
  }
}
console.log(recallJuliusData(reviews, "Julius"));
...
let newobject2 = {
  name: "Ashley",
  rating: 4,
  feedback: "I enjoyed it very much but the burger could be cheaper.",
};
reviews.push(newobject2);
